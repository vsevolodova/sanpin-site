...
Публикуем CTA в формате заявки на внедрение: он помогает быстро зафиксировать интерес, передать запрос менеджеру и перевести потенциального клиента к следующему этапу общения и обсуждения условий.
![Форма  на внедрение](images/scheme.png)


После получения контактов с формы на сайте менеджер оперативно связывается с клиентом и в ходе встречи показывает работу системы: демонстрация проводится вручную.
